...
use App\Http\Controllers\Admin\MkriteriaController;
use App\Http\Controllers\Admin\MdevisiController;
...
Route::group(['prefix' => 'admin','namespace','middleware' => 'auth', 'rasaadmin'],function(){
    ...
    Route::resource('devisim', MdevisiController::class);
    Route::resource('devisim/{devisi}/kriteriam', MkriteriaController::class);
